...
//     gtk_widget_set_visible(GTK_WIDGET(current_grid.first_intro_screen), FALSE);
//     gtk_widget_set_visible(GTK_WIDGET(current_grid.second_intro_screen), FALSE);
//     gtk_widget_set_visible(GTK_WIDGET(current_grid.third_intro_screen), FALSE);
// }

// void set_first_intro_screen_visible() {
//     set_unvisible_intro();
//     gtk_widget_set_visible(GTK_WIDGET(current_grid.first_intro_screen), TRUE);
//     g_timeout_add_seconds(2, (GSourceFunc)set_second_intro_screen_visible, NULL);
// }
// void set_second_intro_screen_visible() {
//     set_unvisible_intro();
//     gtk_widget_set_visible(GTK_WIDGET(current_grid.second_intro_screen), TRUE);
//     g_timeout_add_seconds(1, (GSourceFunc)set_third_intro_screen_visible, NULL);
// }
// void set_third_intro_screen_visible() {
//     set_unvisible_intro();
//     gtk_widget_set_visible(GTK_WIDGET(current_grid.third_intro_screen), TRUE);
// }
...
//     widget_styling(box, current_screen, "intro_welcome_to_the_dark");
//     gtk_grid_attach(GTK_GRID(current_grid.first_intro_screen), box, 0, 0, 1, 1);
// }

// void second_intro_screen() {
//     GtkWidget *welcome = gtk_label_new_with_mnemonic ("second_intro_screen");
//     gtk_grid_attach(GTK_GRID(current_grid.second_intro_screen), welcome, 0, 0, 1, 1);
// }

// static void intro_btn_clicked () {
//     set_unvisible_all();
//     current_grid.is_log_in_clicked = FALSE;
...
//     widget_styling(box, current_screen, "intro_third_box");
//     widget_styling(lab, current_screen, "auth_welcome_to_the_dark");
//     widget_styling(intro_btn, current_screen, "intro_button");
//     gtk_grid_attach(GTK_GRID(current_grid.third_intro_screen), box, 0, 0, 1, 1);
