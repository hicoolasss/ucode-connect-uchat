...
void show_auth() {
    //main auth
    curent_grid.auth_grid = create_grid(586, 544, NULL);
    ...
    gtk_grid_attach(GTK_GRID(curent_grid.auth_grid), curent_grid.log_in_conrainer, 0, 0, 1, 1);
    gtk_grid_attach(GTK_GRID(curent_grid.auth_grid), curent_grid.registration_container, 0, 0, 1, 1);
    ...
    gtk_window_set_child(GTK_WINDOW(curent_screen.screen), curent_grid.auth_grid);
